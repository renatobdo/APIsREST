...
#https://github.com/renatobdo/APIsREST/blob/main/imagens/1_CafeArabica_OpenAI2.png
#https://drive.google.com/file/d/1GpFAJvsn6BjrupX5XRyPj1QZEAu7gNpq/view?usp=sharing
#update cafe set imagem = 'https://drive.google.com/uc?id=1GpFAJvsn6BjrupX5XRyPj1QZEAu7gNpq'
update cafe set imagem = 'https://drive.google.com/uc?id=1GpFAJvsn6BjrupX5XRyPj1QZEAu7gNpq'
where id = 1 and name = 'Arabica';


update cafe set imagem = 'https://drive.google.com/uc?id=11eFaTspPj8nfE_Bz13ydTxMKUJ22ez9m'
where id = 2 and name = 'Bourbon';

update cafe set imagem = 'https://drive.google.com/uc?id=12EaKRl2PN4u1IF63khfB1gKhp8sV7wGo'
where id = 3 and name = 'Acaiá';

update cafe set imagem = 'https://drive.google.com/uc?id=1AHPPQQ9nQ1qEwV8LJb-08X-DJiI4TACc'
where id = 4 and name = 'Catuaí';

update cafe set historia = 'Criado pelo IAC (Instituto Agronômico de Campinas), o Catuaí é uma espécie desenvolvida completamente em território brasileiro. Atualmente, 45% das lavouras cafeeiras produzem esta espécie. Os estudos para que o grão surgisse começaram em 1949 e, em 1972, ele foi lançado oficialmente para os consumidores no mercado. Segundo o pesquisador Gerson Giomo, a variedade é resultado do cruzamento entre o Mundo Novo e o Caturra.O plantio do Catuaí é mais simples. O método foi desenvolvido para facilitar o cultivo para os produtores, com plantas mais baixas e mais resistentes. As plantações situadas acima de 1.000 metros geram bebidas com mais qualidade.O nome do café, inclusive, é uma homenagem aos indígenas tupis-guarani, e significa muito bom.'
where id = 4 and name = 'Catuaí';


update cafe set imagem = 'https://drive.google.com/uc?id=15UtqFhOUfC16IkSavZaOSrY1J0ymNNxM'
where id = 5 and name = 'Robusta';

update cafe set imagem = 'https://drive.google.com/uc?id=1r9PdQKhofeT0isQ5GWi-3xvX-2pyKMZm'
where id = 6 and name = 'Geisha';

update cafe set imagem = 'https://drive.google.com/uc?id=10xRkdKkhU0xCthfdDvezY91QudfqfPha'
